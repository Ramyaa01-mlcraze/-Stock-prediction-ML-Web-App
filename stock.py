...
if (sl.button("About this app")):
    sl.info(
        "This webapp is still under construction and works with limited number of data and some basic machine learning model behind it ")
if (sl.button("Version")):
    sl.info("Version:0.3")
myRate = sl.sidebar.slider("Rate", max_value=5, min_value=1)
if (sl.checkbox("Contact User")):
